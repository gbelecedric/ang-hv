...
const routes: Routes = [
  ...
  { path: 'edit-community/:id', loadChildren: './pages/edit-community/edit-community.module#EditCommunityPageModule' },
  ...
  { path: 'creer-evenement/:m_id', loadChildren: './pages/creer-evenement/creer-evenement.module#CreerEvenementPageModule' },
