...
describe('AjoutAssisteurPage', () => {
  let component: AjoutAssisteurPage;
  let fixture: ComponentFixture<AjoutAssisteurPage>;
  beforeEach(() => {
    ...
    const serviceServiceStub = () => ({
      saveAssist: (value, value1, value2, value3) => ({ subscribe: f => f({}) })
    });
    ...
    fixture = TestBed.createComponent(AjoutAssisteurPage);
  ...
  describe('saveAssiteur', () => {
    it('makes expected calls', () => {
      ...
      spyOn(navControllerStub, 'navigateForward').and.callThrough();
      spyOn(serviceServiceStub, 'saveAssist').and.callThrough();
      component.saveAssiteur();
      expect(component.presentAlert).toHaveBeenCalled();
      expect(navControllerStub.navigateForward).toHaveBeenCalled();
      expect(serviceServiceStub.saveAssist).toHaveBeenCalled();
    });
  });
});
