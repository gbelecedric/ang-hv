...
@NgModule({
  declarations: [AppComponent, NotificationsComponent,
    PopoverComponent, ActionPopComponent, MemberActionComponent,
    EventActionComponent, ValidateEventComponent],
  imports: [
  ...
  entryComponents: [NotificationsComponent,
    PopoverComponent, ActionPopComponent, 
    MemberActionComponent, EventActionComponent,
